##########
# Custom update of plotting parameters for activemini project

# file location on Windows will likely be:
# C:\Users\[USER]\.conda\envs\[ENV NAME]\Lib\site-packages\mediapipe\python\solutions
...
def draw_landmarks(
  ...
  for idx, landmark in enumerate(landmark_list.landmark):
    if ((landmark.HasField('visibility') and
        ...
        (landmark.HasField('presence') and
         landmark.presence < visibility_threshold)):
      continue
    ...
    for connection in connections:
      ...
      if start_idx in idx_to_coordinates and end_idx in idx_to_coordinates:
        ...
        cv2.line(image, idx_to_coordinates[start_idx],
                ...
                #  drawing_spec.color,
                GREEN_COLOR,  # override package default with green
  ...
  if landmark_drawing_spec:
    for idx, landmark_px in idx_to_coordinates.items():
      ...
      cv2.circle(image, landmark_px, circle_border_radius,
                 WHITE_COLOR,
                # BLUE_COLOR,  # overwrite package default
                 drawing_spec.thickness)
